 ...
 * @author null
 */
public class OrderUpdate extends OrderNew {

    /**
     * Creates new form OrderUpdate
     */
    public OrderUpdate(java.awt.Frame parent, boolean modal,UserModel user) throws Exception {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    OrderUpdate dialog = new OrderUpdate(new javax.swing.JFrame(), true,null);
